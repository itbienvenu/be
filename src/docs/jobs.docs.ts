...
export const jobSchemas = {
    ...
    GenerateJobDescriptionRequest: {
        ...
        properties: {
            description: {
                type: "string",
                description: "A simple, rough job description or notes to be expanded by AI.",
                example: "Looking for a senior react developer in Kigali with 5 years experience, focus on performance and team leadership."
            }
        }
    },
        ...
        properties: {
            ...
            data: {
                ...
                properties: {
                    full_description: {
                        type: "string",
                        description: "The full, professional job description generated by AI in markdown format.",
...
export const jobPaths = {
    ...
    "/api/v1/jobs/generate-description": {
        post: {
            tags: ["Jobs"],
            summary: "Generate a full job description from simple input (AI-powered)",
            description:
                "Takes a simple, rough job description or notes from a recruiter and uses AI to expand it into a " +
                "full, professional, and well-structured job description in markdown format. " +
                "The recruiter can then use this expanded text to create a structured job via the standard `POST /api/v1/jobs` endpoint. " +
                "\n\n**Required role:** `recruiter`",
            security: [{ BearerAuth: [] }],
            requestBody: {
                required: true,
                content: {
                    "application/json": {
                        schema: { $ref: "#/components/schemas/GenerateJobDescriptionRequest" }
                    }
                }
            },
            responses: {
                "200": {
                    description: "Full job description generated successfully",
                    content: {
                        "application/json": {
                            schema: { $ref: "#/components/schemas/GenerateJobDescriptionResponse" }
                        }
                    }
                },
                "400": {
